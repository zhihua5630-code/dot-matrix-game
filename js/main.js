...
$(document).ready(async () => {
    ...
    $startBtn.click(() => {
        ...
        showTextPanel(`<h3>欢迎参加捕捉点阵游戏！</h3>
            <p>你将看到两个点阵，其中一个点阵中有一部分点会一致性向左/向右运动，</p>
            <p>另一个点阵的点全部随机运动。请判断哪边点阵的点有一致性运动。在每一轮里，你需要完成两次判断。</p><br>
            ...
            <p>示意图中，左侧点阵代表点一致性向左运动，右侧点阵代表点随机运动。</p><br>
